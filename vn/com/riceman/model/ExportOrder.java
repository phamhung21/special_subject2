...
public class ExportOrder implements Comparable {

  public static final String AttributeName_Quantity = "quantity";
  public static final String AttributeName_ReceiverID= "receiverID";
  public static final String AttributeName_ExportID = "exportID";
  public static final String AttributeName_Price = "price";
  public static final String AttributeName_TotalPrice = "totalPrice";
  public static final String A_rptExOrder = "rptExOrder";
  ...
  @DAttr(name = "receiverID", type = Type.Domain, length = 5, optional = false)
  @DAssoc(ascName = "receiverID-has-enrolments", role = "enrolment", 
    ascType = AssocType.One2Many, endType = AssocEndType.Many, 
    associate = @Associate(type = Receiver.class, cardMin = 1, cardMax = 1), dependsOn = true)
  private Receiver receiverID;

  @DAttr(name = "exportID", type = Type.Domain, length = 5, optional = false)
  @DAssoc(ascName = "exportID-has-enrolments", role = "enrolment", 
    ascType = AssocType.One2Many, endType = AssocEndType.Many, 
    associate = @Associate(type = Export.class, cardMin = 1, cardMax = 1), dependsOn = true)
  ...
  @DAttr(name=A_rptExOrder,type=Type.Domain, serialisable=false, 
	      ...
	      virtual=true)
	  private ExportOrder rptExOrder;
  ...
  public ExportOrder(@AttrRef("riceID") Rice r, @AttrRef("receiverID") Receiver s, 
      @AttrRef("exportID") Export m) throws ConstraintViolationException {
    this(null, r, s, m, 0, 0, null);
  }

  @DOpt(type=DOpt.Type.ObjectFormConstructor)
  public ExportOrder(
		  @AttrRef("riceID") Rice r, 
		  @AttrRef("receiverID") Receiver s, 
		  @AttrRef("exportID") Export m, 
		  @AttrRef("quantity") Integer quantity, 
      @AttrRef("price") Integer price)
      throws ConstraintViolationException {
    this(null, r, s, m, quantity, price, null);
  }

  // @version 2.0
  @DOpt(type=DOpt.Type.DataSourceConstructor)
  public ExportOrder(Integer id, Rice r, Receiver s, Export m, Integer quantity,
      Integer price, 
  ...
  // setter methods
  public void setRiceID(Rice r) {
	    this.riceID = r;
  }
  
  public void setReceiverID(Receiver s) {
    this.receiverID = s;
  }

  public void setExportID(Export m) {
    this.exportID = m;
  }
  ...
  public String toString(boolean full) {
    if (full)
      return "Order(" + receiverID + "," + exportID + ")";
    else
      return "Order(" + getId() + "," + receiverID.getId() + ","
//          + exportID.getCode() 
          + 
          ")";
  }
  ...
  public boolean equals(Object obj) {
    ...
    if (getClass() != obj.getClass())
      return false;
    ExportOrder other = (ExportOrder) obj;
    if (id != other.id)
      return false;
    return true;
  }
  ...
  public int compareTo(Object o) {
    if (o == null || (!(o instanceof ExportOrder)))
      return -1;

    ExportOrder e = (ExportOrder) o;

    return this.receiverID.getId().compareTo(e.receiverID.getId());
  }
}
