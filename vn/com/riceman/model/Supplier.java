...
public class Supplier {
	...
	public static final String A_rptSupByName = "rptSupByName";
	...
	@DAttr(name = A_phone, type = Type.Integer, length = 25, optional = false)
	...
	// v5.0: to realise link to report
	  @DAttr(name=A_rptSupByName,type=Type.Domain, serialisable=false, 
	      ...
	      virtual=true)
	  private SupplierByNameReport rptSupByName;
